...
const secondTimestampThreshold = 9999999999;
...
export const normalizeTimeValue = (value: TimeValue) => {
  ...
  if (typeof value === 'string') {
    ...
    if (!Number.isNaN(numericValue)) {
      ...
      return numericValue > secondTimestampThreshold ? numericValue : numericValue * 1000;
    }
    return trimmed;
  }
  ...
  return value > secondTimestampThreshold ? value : value * 1000;
};
